...
export const BUILTIN_FOODS: FoodItem[] = [
  // ---- proteins
  f("chicken-breast", "Chicken breast", "雞胸肉", "🍗", "protein", 120, 22.5, 0, 2.6, { servingEn: "1 piece", servingZh: "1 塊", servingG: 150 }),
  f("chicken-thigh", "Chicken thigh (boneless)", "去骨雞腿肉", "🍗", "protein", 177, 18.6, 0, 10.9, { servingEn: "1 thigh", servingZh: "1 隻", servingG: 130 }),
  f("chicken-wings", "Chicken wings", "雞翅", "🍗", "protein", 203, 18.3, 0, 14.1, { servingEn: "3 wings", servingZh: "3 隻", servingG: 90 }),
  ...
  f("ground-pork", "Ground pork", "豬絞肉", "🥩", "protein", 263, 16.9, 0, 21.2),
  f("beef-sirloin", "Sirloin steak", "沙朗牛排", "🥩", "protein", 201, 26, 0, 10, { servingEn: "1 steak", servingZh: "1 塊", servingG: 200 }),
  f("ground-beef", "Ground beef", "牛絞肉", "🥩", "protein", 250, 17, 0, 20),
  f("salmon", "Salmon fillet", "鮭魚", "🐟", "protein", 208, 20, 0, 13, { servingEn: "1 fillet", servingZh: "1 片", servingG: 150 }),
  f("shrimp", "Shrimp", "蝦仁", "🦐", "protein", 99, 24, 0.2, 0.3, { servingEn: "6 shrimp", servingZh: "6 隻", servingG: 85 }),
  f("egg", "Egg", "雞蛋", "🥚", "protein", 143, 12.6, 0.7, 9.5, { servingEn: "1 egg", servingZh: "1 顆", servingG: 55 }),
  ...
  f("fish-balls", "Fish balls", "魚丸", "🍥", "protein", 130, 11, 12, 3.5, { servingEn: "4 balls", servingZh: "4 顆", servingG: 80 }),
  f("naruto", "Narutomaki (fish cake)", "鳴門卷", "🍥", "protein", 90, 8, 12, 0.9, { servingEn: "3 slices", servingZh: "3 片", servingG: 30 }),
  f("whey", "Whey protein (1 scoop)", "乳清蛋白（1 匙）", "🥤", "protein", 400, 80, 8, 6, { servingEn: "1 scoop", servingZh: "1 匙", servingG: 32 }),
  f("bacon", "Bacon", "培根", "🥓", "protein", 541, 37, 1.4, 42, { servingEn: "2 strips", servingZh: "2 片", servingG: 30 }),
  f("ham", "Ham slice", "火腿片", "🍖", "protein", 145, 18, 1.5, 7.5, { servingEn: "2 slices", servingZh: "2 片", servingG: 40 }),
  ...
  f("potato", "Potato", "馬鈴薯", "🥔", "carb", 77, 2, 17, 0.1, { servingEn: "1 medium", servingZh: "1 顆", servingG: 180 }),
  f("sweet-potato", "Sweet potato", "地瓜", "🍠", "carb", 86, 1.6, 20, 0.1, { servingEn: "1 medium", servingZh: "1 條", servingG: 150 }),
  ...
  f("green-peas", "Green peas", "豌豆", "🫛", "veg", 81, 5.4, 14.5, 0.4, { servingEn: "1 cup", servingZh: "1 碗", servingG: 100 }),
  f("broccoli", "Broccoli", "花椰菜", "🥦", "veg", 34, 2.8, 6.6, 0.4, { servingEn: "1 cup", servingZh: "1 碗", servingG: 90 }),
  f("spinach", "Spinach", "菠菜", "🥬", "veg", 23, 2.9, 3.6, 0.4, { servingEn: "1 bunch", servingZh: "1 把", servingG: 100 }),
  f("cabbage", "Cabbage", "高麗菜", "🥬", "veg", 25, 1.3, 5.8, 0.1, { servingEn: "1 cup", servingZh: "1 碗", servingG: 90 }),
  f("bok-choy", "Bok choy", "青江菜", "🥬", "veg", 13, 1.5, 2.2, 0.2, { servingEn: "1 cup", servingZh: "1 碗", servingG: 85 }),
  ...
  f("cucumber", "Cucumber", "小黃瓜", "🥒", "veg", 15, 0.7, 3.6, 0.1, { servingEn: "1 whole", servingZh: "1 條", servingG: 100 }),
  f("corn", "Sweet corn", "玉米粒", "🌽", "veg", 86, 3.3, 19, 1.4, { servingEn: "1/2 cup", servingZh: "半碗", servingG: 80 }),
  f("napa", "Napa cabbage", "大白菜", "🥬", "veg", 16, 1.2, 3.2, 0.2, { servingEn: "1 cup", servingZh: "1 碗", servingG: 85 }),
  ...
  f("honeydew", "Honeydew melon", "哈密瓜（蜜瓜）", "🍈", "fruit", 36, 0.5, 9.1, 0.1, { servingEn: "1 wedge", servingZh: "1 片", servingG: 160 }),
  f("cantaloupe", "Cantaloupe", "香瓜", "🍈", "fruit", 34, 0.8, 8.2, 0.2, { servingEn: "1 wedge", servingZh: "1 片", servingG: 160 }),
  f("watermelon", "Watermelon", "西瓜", "🍉", "fruit", 30, 0.6, 7.6, 0.2, { servingEn: "1 slice", servingZh: "1 片", servingG: 280 }),
  f("blueberry", "Blueberries", "藍莓", "🫐", "fruit", 57, 0.7, 14.5, 0.3, { servingEn: "1/2 box", servingZh: "半盒", servingG: 60 }),
  f("strawberry", "Strawberries", "草莓", "🍓", "fruit", 32, 0.7, 7.7, 0.3, { servingEn: "5 berries", servingZh: "5 顆", servingG: 80 }),
  f("avocado", "Avocado", "酪梨", "🥑", "fruit", 160, 2, 8.5, 14.7, { servingEn: "1/2 avocado", servingZh: "半顆", servingG: 70 }),
  f("grapes", "Grapes", "葡萄", "🍇", "fruit", 69, 0.7, 18.1, 0.2, { servingEn: "1 cup", servingZh: "1 碗", servingG: 90 }),

  // ---- dairy
  f("milk", "Whole milk", "全脂鮮奶", "🥛", "dairy", 61, 3.2, 4.8, 3.3, { servingEn: "1 glass", servingZh: "1 杯", servingG: 240 }),
  ...
  f("cheese", "Cheddar cheese", "起司片", "🧀", "dairy", 403, 24.9, 1.3, 33.1, { servingEn: "1 slice", servingZh: "1 片", servingG: 20 }),
  f("parmesan", "Parmesan", "帕瑪森起司", "🧀", "dairy", 431, 38.5, 4.1, 29, { servingEn: "2 tbsp", servingZh: "2 匙", servingG: 10 }),
  f("mozzarella", "Mozzarella", "莫札瑞拉起司", "🧀", "dairy", 280, 28, 3.1, 17, { servingEn: "1/4 cup", servingZh: "1/4 杯", servingG: 28 }),
  f("cream", "Heavy cream", "鮮奶油", "🥛", "dairy", 340, 2.8, 2.8, 36, { servingEn: "2 tbsp", servingZh: "2 匙", servingG: 30 }),
  ...
  f("pesto", "Pesto sauce", "青醬", "🥫", "sauce", 418, 4.5, 6, 42, { servingEn: "2 tbsp", servingZh: "2 匙", servingG: 32 }),
  ...
  // ---- snacks & drinks
  f("dark-chocolate", "Dark chocolate", "黑巧克力", "🍫", "snack", 546, 4.9, 61, 31, { servingEn: "2 squares", servingZh: "2 小格", servingG: 20 }),
  ...
  f("black-coffee", "Black coffee", "黑咖啡", "☕", "drink", 2, 0.1, 0, 0, { servingEn: "1 cup", servingZh: "1 杯", servingG: 240 }),
